...
class Title extends MdbBase
{
    ...
    */
     ...
     * @see IMDB page /fullcredits
     */
    public function cast($short = false,$count=8)
    {
        if ($short) {
            return $this->cast_short($count);
        }
        ...
        foreach ($cast_rows as $cast_row) {
            ...
            if(count($this->credits_cast) >= $count){
                break;
            }
        }
        return $this->credits_cast;
    ...
    protected function cast_short($count = 8)
    {
        ...
        foreach ($nodes as $i => $node) {
            ...
            if(count($this->credits_cast_short) >= $count){
                break;
            }
        }
